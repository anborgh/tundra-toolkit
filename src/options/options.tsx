					...
					<section className="optionsGuide">
						...
						<div className="optionsGuideBlock" id="guide-episodes">
							...
							<ul>
								...
								<li>Нажмите метку «ход» или «жду» слева от темы, чтобы переключить очередь. Tundra Toolkit не определяет, чей сейчас ход, — отметку нужно ставить и снимать вручную.</li>
